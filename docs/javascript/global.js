...
<div id="toTopBtn"
  class="fixed bottom-5 right-5 z-40 flex h-12 w-12 translate-y-4 items-center justify-center rounded-full bg-[#115631] text-white shadow-lg transition-all duration-500 opacity-0 pointer-events-none hover:bg-[#2a241f]">
